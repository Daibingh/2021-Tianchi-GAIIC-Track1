...
python train.py -f config/task1/bert.json --random_seed 937 --n_fold 20 --pred_W 5
...
python train.py -f config/task2/bert.json --random_seed 937 --n_fold 20 --pred_W 5
